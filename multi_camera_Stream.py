    ...
    def pushFrame(self):
        ...
        if ret:
            ...
            if hasFrame:
                ...
                now = datetime.now()
                objectName = "images/{}/{}/{}_{}_{}_{:0=2d}_{:0=2d}_{:0=2d}_{:0=2d}_{:0=2d}.jpg".format(
                ...
                #   s3Client.put_object(Body=imageBytes.tobytes(), Bucket=self.cameraSettings.s3Bucket, Key=objectName, ContentType="image/jpg", Metadata=md)  // esta se usara en la version online
                cv2.imwrite(objectName, frame);
